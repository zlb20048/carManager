...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		inactiveBitmap = Util.drawableToBitmap(a
				.getDrawable(R.styleable.CircleFlowIndicator_inactiveDrawable));

		activeBitmap = Util.drawableToBitmap(a
				.getDrawable(R.styleable.CircleFlowIndicator_activeDrawable));
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawBitmap(activeBitmap, leftPadding + radius + cx
				+ centeringOffset, getPaddingTop() + radius, null);
	}
